...
I will be using a box and whisker plot as my graphical means of exploring this data and variable analysis (comparing the numerical factor [amount of pushups] with the factor variables [player positions: linemen & skill players]) as my numerical means of exploring the data. 
