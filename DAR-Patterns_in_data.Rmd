...
The data frame contains 30 observations that have been measured on the following variables: weight (lbs.), amount of pushups completed, and the players' positions on the team (line or skill). The study was conducted by MAT 111 students at Georgetown College. In this report, we will be weighing the amount of pushups a skill player can do against the amount of pushups a line player can do and see who can do more. 
